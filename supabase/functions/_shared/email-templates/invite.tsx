...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to ProDG 360° Review</Preview>
    <Body style={main}>
      <Container style={outerContainer}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={text}>
            You've been invited to join the ProDG 360° Review platform. Click the button below to accept the invitation and create your account.
          </Text>
