...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to VGG 360° Appraisal</Preview>
    <Body style={main}>
      <Container style={outerContainer}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={text}>
            You've been invited to join the VGG 360° Appraisal platform. Click the button below to accept the invitation and create your account.
          </Text>
