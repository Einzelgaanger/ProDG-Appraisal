...
export const RecoveryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your password for VGG 360° Appraisal</Preview>
    <Body style={main}>
      <Container style={outerContainer}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={text}>
            We received a request to reset your password for VGG 360° Appraisal. Click the button below to choose a new password.
          </Text>
