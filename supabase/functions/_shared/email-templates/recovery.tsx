...
export const RecoveryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your password for ProDG 360° Review</Preview>
    <Body style={main}>
      <Container style={outerContainer}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={text}>
            We received a request to reset your password for ProDG 360° Review. Click the button below to choose a new password.
          </Text>
